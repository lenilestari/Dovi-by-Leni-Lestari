...
class CekOtpVerifikasiEmail : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cek_otp_verifikasi_email)
    ...
    private fun verifikasiOtp() {
        ...
        val savedEmail = SharedPreferenceLogin.getEmail(this@CekOtpVerifikasiEmail)
        val requestBody = RequestCekOtp(otp = inputOtp, email = savedEmail)

        ApiClient
            .create().ApiCekOtp(requestBody).enqueue(object :
                ...
                if (response.isSuccessful) {
                    ...
                    responseAPI?.let {
                        if (response.code() == 200) {
                            startActivity(Intent(this@CekOtpVerifikasiEmail, GantiKataSandi::class.java))
                            finish()
                            Loading.visibility = View.GONE
                        }
                    }
                    ...
                    try{
                        ...
                        if (status == "400"){
                            val alertDialogBuilder = AlertDialog.Builder(this@CekOtpVerifikasiEmail)
            ...
            override fun onFailure(call: Call<ResponseCekOtp>, t: Throwable) {
                ...
                Toast.makeText(this@CekOtpVerifikasiEmail,"Periksa koneksi internet anda", Toast.LENGTH_SHORT).show()
            }
