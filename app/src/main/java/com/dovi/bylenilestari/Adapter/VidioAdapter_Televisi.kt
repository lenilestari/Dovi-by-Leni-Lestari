...
class VideoAdapter_Televisi(private var videoList: List<DataItem3?>, private val apiService: APIServices) :
    RecyclerView.Adapter<VideoAdapter_Televisi.VideoViewHolder>() {
