...
import com.dovi.bylenilestari.YouLikeFull

class VideoAdapter_YouLike(private val videoList: List<DataItem3?>) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is VideoViewHolder) {
            ...
            holder.itemView.setOnClickListener {
                val intent = Intent(holder.itemView.context, YouLikeFull::class.java)
